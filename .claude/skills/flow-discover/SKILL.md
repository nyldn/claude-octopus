...
**You (Claude) synthesize the collected results directly in conversation.** This replaces the previous external synthesis call that frequently timed out.
...
- External providers such as Codex, Antigravity, and Perplexity provide broad ecosystem research
...
- 🧭 Antigravity CLI uses your Antigravity access/subscription (costs apply)
