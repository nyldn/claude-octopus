    ...
    case "$phase" in
        discover)
            case "$agent_base" in
                ...
                agy*|antigravity) verb="🧭 Exploring ecosystem and options (Antigravity)" ;;
        ...
        define)
            case "$agent_base" in
                ...
                agy*|antigravity) verb="🧭 Clarifying scope and constraints (Antigravity)" ;;
        ...
        develop)
            case "$agent_base" in
                ...
                agy*|antigravity) verb="🧭 Exploring alternative approaches (Antigravity)" ;;
        ...
        deliver)
            case "$agent_base" in
                ...
                agy*|antigravity) verb="🧭 Testing edge cases and security (Antigravity)" ;;
