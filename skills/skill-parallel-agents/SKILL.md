...
| 🧭 Antigravity CLI | Bundled | Your Antigravity access/subscription |
...
> ```
> Sign in with your Antigravity access/subscription.
>
...
| `agy` | Antigravity (Gemini 3.x backend) | Deep analysis, 1M context |
...
| **Antigravity** | Access/subscription | Bundled | code, chat, vision, long-context |
...
**Example:** If you have Antigravity access bundled with your account, the system prefers Antigravity for heavy analysis tasks since it's "free" with your subscription.
...
providers:
  ...
  agy:
    installed: true
    auth_method: "oauth"
    subscription_tier: "subscription"  # access|subscription|api-only
    cost_tier: "bundled"
