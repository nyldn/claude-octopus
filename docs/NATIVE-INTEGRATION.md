...
# Run migration
~/.claude/plugins/cache/adrivellen-plugins/claude-octopus/7.23.0/scripts/migrate-todos.sh
...
**Questions?** Open an issue: https://github.com/adrivellen/claude-octopus/issues
