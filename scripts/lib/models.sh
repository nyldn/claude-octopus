...
get_model_catalog() {
    ...
    case "$model" in
        ...
        gemini-3.5-flash)         echo "1000|yes|no|no|gemini|standard|active" ;;  # GA fast (supersedes gemini-3-flash-preview)
        ...
        gemini-3-pro-image-preview) echo "1000|yes|yes|no|gemini|premium|deprecated" ;;  # shutdown 2026-06-25 (oco-803), migrate to Nano Banana Pro
