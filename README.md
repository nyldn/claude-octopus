...
> 🆕 **v9.61.3 — Auth-aware provider status for codex/opencode/copilot in the availability banner.**
>
...
|---------|--------------|
| **v9.61.3** (new) | Auth-aware provider status for codex/opencode/copilot in the availability banner. |
