...
> 🆕 **v9.59.0 — Three dispatch-reliability fixes: Round 1 review survives a failed spawn, the OpenRouter council seat works again, and five set -e status leaks no longer abort functions after their work succeeded.**
>
...
|---------|--------------|
| **v9.59.0** (new) | Three dispatch-reliability fixes: Round 1 review survives a failed spawn, the OpenRouter council seat works again, and five set -e status leaks no longer abort functions after their work succeeded. |
