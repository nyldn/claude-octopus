...
init_interactive() {
    ...
    echo -e "    ${GREEN}export AGY_API_KEY=\"...\"${NC}  (for Antigravity)"
    echo ""
...
ERROR_CODES=(
    ...
    "E002:Antigravity (agy) API key not set — set AGY_API_KEY (if in ~/.bashrc, move to ~/.profile — bashrc is skipped in non-interactive shells):export AGY_API_KEY=\"...\" && orchestrate.sh preflight:help api-setup"
    "E003:Codex CLI not found:npm install -g @openai/codex:help setup"
    "E004:Antigravity CLI (agy) not found:npm install -g @antigravity/agy:help setup"
