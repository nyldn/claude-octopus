...
This is a shortcut alias for `/octo:skill-tdd`.

Test-driven development workflow following red-green-refactor discipline.

For full documentation, see `/octo:skill-tdd`.
