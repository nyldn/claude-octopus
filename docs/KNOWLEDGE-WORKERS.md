...
- Use the `agy` CLI as your primary provider (1M+ context window).
...
A: We recommend **Antigravity service-selected model** for Phases 1 and 2 (due to the 1M+ context window) and **Claude Opus** for Phase 3 (due to reasoning depth).
...
| **Primary CLI** | `codex` (Elite code generation) | `agy` (Google Antigravity analysis) |
...
- **Decision Tree:** [AGENTS.md](AGENTS.md#decision-tree)
