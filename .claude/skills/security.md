...
This is a shortcut alias for `/octo:skill-security-audit`.

Comprehensive security auditing for vulnerability detection and OWASP compliance.

For full documentation, see `/octo:skill-security-audit`.
