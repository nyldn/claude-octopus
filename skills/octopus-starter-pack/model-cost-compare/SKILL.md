...
3. **Price the roster.** Using the cost table in CLAUDE.md ($/MTok input/output), compute the estimated cost for each plausible seat: Claude Opus 5.5 ($4/$20), Claude Opus 5 ($5/$25), Claude Sonnet 5 ($2/$10), Fable 5.1 ($10/$50, 1M context, explicit-only), Codex GPT-6 Sol ($2/$10), GPT-6 Luna ($0.10/$0.50), GPT-5.6 Sol ($4/$20, rollout fallback), GPT-6 Astra ($10/$50, explicit-only), Perplexity Sonar Pro ($3/$15), and the included-cost seats (agy, copilot, ollama, cursor-agent) at $0. For GPT-6 requests above 272K input tokens, apply 2x input and 1.5x output pricing to the full request.
