...
> 🆕 **v9.61.1 — Vendor-correct model fallbacks, single-owner provider lockout, and skill-generator directory safety.**
>
...
|---------|--------------|
| **v9.61.1** (new) | Vendor-correct model fallbacks, single-owner provider lockout, and skill-generator directory safety. |
