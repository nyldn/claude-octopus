...
> 🆕 **v9.59.0 — Two dispatch-reliability fixes: Round 1 review no longer aborts on a single failed spawn, and the OpenRouter council seat works again.**
>
...
|---------|--------------|
| **v9.59.0** (new) | Two dispatch-reliability fixes: Round 1 review no longer aborts on a single failed spawn, and the OpenRouter council seat works again. |
