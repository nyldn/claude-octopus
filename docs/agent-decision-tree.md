...
└─ Multiple concerns   → Use /co:review skill
```
...
| Skill | Does What |
|-------|-----------|
| `/co:review` | Fast code review (define + develop) |
| `/co:research` | Deep research (4-perspective discover) |
| `/co:security` | Security audit (red team/blue team) |
