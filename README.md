...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-11.9.1-blue" alt="Version 11.9.1">
...
🧠 **Remembers across sessions.** Integrates with [claude-mem](https://github.com/thedotmack/claude-mem), [agentmemory](https://github.com/rohitg00/agentmemory), and [deja-vu](https://github.com/vshulcz/deja-vu) for persistent memory — past decisions, research, and context survive session boundaries.
...
> 🆕 **v11.9.1 — Make Define honor --timeout, finish when a provider seat fails, and skip an out-of-quota Antigravity seat.**
>
...
|---------|--------------|
| **v11.9.1** (new) | Make Define honor --timeout, finish when a provider seat fails, and skip an out-of-quota Antigravity seat. |
