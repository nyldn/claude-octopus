...
> 🆕 **v9.59.0 — Provider identity now comes from one registry, and ten reliability fixes: orphaned provider children are reaped, council seats cancel without a race or pgrep, the OpenRouter seat works again, and debate-gate checkpoints are readable. Adds literal provider-model routing.**
>
...
|---------|--------------|
| **v9.59.0** (new) | Provider identity now comes from one registry, and ten reliability fixes: orphaned provider children are reaped, council seats cancel without a race or pgrep, the OpenRouter seat works again, and debate-gate checkpoints are readable. Adds literal provider-model routing. |
