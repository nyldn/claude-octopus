...
export const SKILL_REGISTRY = [
    ...
    { name: "skill-intent-contract", description: "Guard against scope drift — use at the start of complex or ambiguous tasks before any implementation", type: "skill", file: "skill-intent-contract/SKILL.md" },
    ...
    { name: "skill-native-escalation-routing", description: "Routing decision for init, review, and security requests — use when choosing between Claude-native handling and multi-LLM orchestration", type: "skill", file: "skill-native-escalation-routing/SKILL.md" },
    ...
    { name: "skill-review-response", description: "Respond to code review feedback — use whenever a reviewer, CI bot, or another AI has left comments to address", type: "skill", file: "skill-review-response/SKILL.md" },
    ...
    { name: "skill-staged-review", description: "Thorough PR or feature review — use when a change must be checked against both its spec and code quality standards", type: "skill", file: "skill-staged-review/SKILL.md" },
    ...
    { name: "skill-verification-gate", description: "Gate on completion claims — use before declaring any work complete, fixed, passing, or done", type: "skill", file: "skill-verification-gate/SKILL.md" },
