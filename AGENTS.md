...
- **Adapter environment**: MCP and OpenClaw load provider credential and transport names from `config/provider-env-allowlist.json`; the dispatch plan narrows each child to its selected credential.
