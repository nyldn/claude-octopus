...
This is a shortcut alias for `/octo:skill-deep-research`.

Deep research workflow with multi-source synthesis and comprehensive analysis.

For full documentation, see `/octo:skill-deep-research`.
